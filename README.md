<p align="center">
  <img src="assets/logo.png" alt="s_vdet logo" width="180">
</p>
...
Built as a companion to [`s_guard`](.) and [`s_detector`](.) — same
"detect problems before they matter" philosophy, applied to network
infrastructure instead of browser traffic.
...
|---|---|---|---|---|---|
| Supported | ✅ | ✅ | ✅ | ⚠️ partial | ❌ (locked-down by design) |
